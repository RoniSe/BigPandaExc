@REM bigpandaexc launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM BIGPANDAEXC_config.txt found in the BIGPANDAEXC_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%BIGPANDAEXC_HOME%"=="" set "BIGPANDAEXC_HOME=%~dp0\\.."

set "APP_LIB_DIR=%BIGPANDAEXC_HOME%\lib\"
...
set "CFG_FILE=%BIGPANDAEXC_HOME%\BIGPANDAEXC_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running bigpandaexc.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !BIGPANDAEXC_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
